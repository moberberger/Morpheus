...
namespace Morpheus.Standard.UnitTests
{
    ...
    public class LineSegmentTests
    {
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 10, 4 );
            var ls2 = new CLineSegment( 6, 2, 7, 2 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 10, 4 );
            var ls2 = new CLineSegment( 6, 2, 20, 2 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 2, 0 );
            var ls2 = new CLineSegment( 1, 1, 3, 1 );
        ...
        {
            var ls1 = new CLineSegment( -1, 0, 1, 0 );
            var ls2 = new CLineSegment( 0, 1, 0, -1 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 2, 0 );
            var ls2 = new CLineSegment( 1, 0, 1, 4 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 2, 0 );
            var ls2 = new CLineSegment( 2, 0, 2, 4 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 2, 0 );
            var ls2 = new CLineSegment( 3, 0, 3, 1 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 2, 2 );
            var ls2 = new CLineSegment( 3, 3, 5, 5 );
        ...
        {
            var ls1 = new CLineSegment( 0, 0, 2, 0 );
            var ls2 = new CLineSegment( 1, 0, 3, 0 );
            ...
            ls1 = new CLineSegment( 1, 1, 3, 3 );
            ls2 = new CLineSegment( 2, 2, 0, 0 );
