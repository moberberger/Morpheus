    ...
    public partial class CSerializeTest
    {
        ...
        public void TestInvalidType()
        {
            ...
            Assert.AreEqual( x.GetType().AssemblyQualifiedName,
                             CXmlHelper.GetAttributeValue( elem, s.Context.TypeAttributeName ),
        ...
        public void TestCircularReference()
        {
            ...
            var id = CXmlHelper.GetAttributeValue( elem, c.ReferenceIdAttributeName );
            Assert.AreEqual( "69", CXmlHelper.GetElementValue( elem, "Data" ), "The first node's data is wrong" );
            var e2 = (XmlElement) elem.SelectSingleNode( "Next" );
            Assert.AreEqual( "70", CXmlHelper.GetElementValue( e2, "Data" ), "The second node's data is wrong" );

            var e3 = (XmlElement) e2.SelectSingleNode( "Next" );
            var rid = CXmlHelper.GetAttributeValue( e3, c.ReferToAttributeName );
        ...
        private static void AssureCorrectReference( XmlElement elem, int a1, int a2 )
        {
            ...
            var id = CXmlHelper.GetAttributeValue( n, "_ID" );

            var n2 = elem.SelectSingleNode( "//_[@_I=" + a2 + "]" );
            var rid = CXmlHelper.GetAttributeValue( n2, "_RID" );
        ...
        public void TestNullableType()
        {
            ...
            Assert.AreEqual( CSerializationContext.Global.NullAttributeValue,
                             CXmlHelper.GetAttributeValue( elem, CSerializationContext.Global.NullAttributeName ),
                             "Should be null" );
            ...
            Assert.AreEqual( x.GetType().AssemblyQualifiedName,
                             CXmlHelper.GetAttributeValue( elem, CSerializationContext.Global.TypeAttributeName ),
                             "The Type is wrong" );
        }
        ...
        public void TestSparseMultidimArray()
        {
            ...
            Assert.AreEqual( "3,4,5",
                             CXmlHelper.GetAttributeValue( elem, c.ArrayAttributeName ),
                             "Array Lengths are wrong" );
            Assert.AreEqual( "3,2,1",
                             CXmlHelper.GetAttributeValue( elem, c.ArrayLowerBoundAttribute ),
                             "Array Lowerbounds are wrong" );

            Assert.AreEqual( "3,5,3",
                             CXmlHelper.GetAttributeValue( elem.ChildNodes[0], c.ArrayIndexAttributeName ),
                             "Index value is wrong" );
            Assert.AreEqual( "4,4,1",
                             CXmlHelper.GetAttributeValue( elem.ChildNodes[1], c.ArrayIndexAttributeName ),
                             "Index value is wrong" );
            Assert.AreEqual( "5,2,5",
                             CXmlHelper.GetAttributeValue( elem.ChildNodes[4], c.ArrayIndexAttributeName ),
                             "Index value is wrong" );
            Assert.IsNull( CXmlHelper.GetAttributeValue( elem.ChildNodes[2], c.ArrayIndexAttributeName ),
                           "Should be no index attribute for sequential element" );
            Assert.IsNull( CXmlHelper.GetAttributeValue( elem.ChildNodes[3], c.ArrayIndexAttributeName ),
                           "Should be no index attribute for sequential element" );
        }
        ...
        public void TestExternalBaseSurrogate()
        {
            ...
            Assert.AreEqual( x.Name, CXmlHelper.GetElementValue( elem, "Name" ), "Name" );
            Assert.AreEqual( x.Age.ToString(), CXmlHelper.GetElementValue( elem, "Age" ), "Age" );
            Assert.AreEqual( x.Sex, CXmlHelper.GetElementValue( elem, "Sex" ), "Sex" );
            ...
            Assert.AreEqual( 1, elem.ChildNodes.Count, "Child Node Count is wrong" );
            Assert.AreEqual( x.Name, CXmlHelper.GetAttributeValue( elem, "NAME" ), "Name" );
            Assert.AreEqual( x.Age.ToString(), CXmlHelper.GetAttributeValue( elem, "AGE" ), "Age" );
            Assert.AreEqual( x.Sex, CXmlHelper.GetElementValue( elem, "Sex" ), "Sex" );
        }
        ...
        public void TestSuperclassedArray()
        {
            ...
            Assert.AreEqual( x.Arr.GetType().AssemblyQualifiedName,
                             CXmlHelper.GetAttributeValue( e, s.Context.TypeAttributeName ),
                             "Type Attribute Error" );
            Assert.AreEqual( x.Arr.Length.ToString(),
                             CXmlHelper.GetAttributeValue( e, s.Context.ArrayAttributeName ),
        ...
        public void TestCPerson()
        {
            ...
            Assert.AreEqual( x.m_name, CXmlHelper.GetElementValue( elem, "Name" ), "Name" );
            Assert.AreEqual( x.m_age.ToString(), CXmlHelper.GetElementValue( elem, "Age" ), "Age" );

            var e = (XmlElement) elem.SelectSingleNode( "KidsNames" );
            Assert.IsNotNull( e, "Missing KidsNames element" );
            Assert.AreEqual( "3", CXmlHelper.GetAttributeValue( e, s.Context.ArrayAttributeName ), "Kids Array Count" );
            ...
            Assert.AreEqual( s.Context.NullAttributeValue,
                             CXmlHelper.GetAttributeValue( e, s.Context.NullAttributeName ),
                             "Null Attribute Error" );

            e = (XmlElement) elem.SelectSingleNode( "Address" );
            Assert.IsNotNull( e, "Missing Address element" );
            Assert.AreEqual( x.m_address.m_city, CXmlHelper.GetElementValue( e, "City" ), "Address-City" );
            Assert.AreEqual( x.m_address.m_street, CXmlHelper.GetElementValue( e, "Street" ), "Address-Street" );
            Assert.AreEqual( x.m_address.m_zip.ToString(), CXmlHelper.GetElementValue( e, "Zip" ), "Address-Zip" );
            ...
            Assert.AreEqual( sa.m_country, CXmlHelper.GetElementValue( e, "Country" ), "OtherAddress-Country" );
            Assert.AreEqual( sa.m_city, CXmlHelper.GetElementValue( e, "City" ), "Address-City" );
            Assert.AreEqual( sa.m_street, CXmlHelper.GetElementValue( e, "Street" ), "Address-Street" );
            Assert.AreEqual( sa.m_zip.ToString(), CXmlHelper.GetElementValue( e, "Zip" ), "Address-Zip" );
        }
        ...
        public void TestCPersonExplicitArrays()
        {
            ...
            for (var i = 0; i < x.m_kidsNames.Length; i++)
            {
                ...
                Assert.AreEqual( i.ToString(),
                                 CXmlHelper.GetAttributeValue( e.ChildNodes[i], s.Context.ArrayIndexAttributeName ),
                                 "Array Index " + i );
            }
        ...
        public void TestSparseArray()
        {
            ...
            Assert.AreEqual( "75",
                             CXmlHelper.GetAttributeValue( elem.ChildNodes[3], c.ArrayIndexAttributeName ),
        ...
        public void TestNonstandardArray()
        {
            ...
            Assert.AreEqual( x.GetLowerBound( 0 ).ToString(),
                             CXmlHelper.GetAttributeValue( elem, s.Context.ArrayLowerBoundAttribute ),
        ...
        public void TestArray_Primitive()
        {
            ...
            Assert.AreEqual( a.GetType().AssemblyQualifiedName,
                             CXmlHelper.GetAttributeValue( e, s.Context.TypeAttributeName ),
                             "The Type attribute is wrong" );
            Assert.AreEqual( int.Parse( CXmlHelper.GetAttributeValue( e, s.Context.ArrayAttributeName ) ),
                             a.Length,
