...
namespace Morpheus.Standard.UnitTests.Stochastics
{
    ...
    public class NotRandomExtensionsTests
    {
        ...
        [TestMethod]
        public void NotRandomDouble_BR_Test()
        {
            var mem = new MemoryStream();
            using (var writer = new BinaryWriter( mem ))
            {
                ...
                var notRandom = new NotRandomFromBytes( mem.ToArray(), true );
        ...
        public void NotRandomDouble_Ratio_Test()
        {
            ...
            using (var writer = new BinaryWriter( mem ))
            {
                ...
                var notRandom = new NotRandomFromBytes( mem.ToArray(), false );
