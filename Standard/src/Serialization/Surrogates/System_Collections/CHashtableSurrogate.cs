...
internal class CHashtableSurrogate : CSystemCollectionsBaseSurrogate<Hashtable, DictionaryEntry>, IExternalSurrogate
{
    ...
    public bool Serialize( object _object, Type _useType, XmlElement _parentNode, CSerializer _serializer ) => 
        BaseSerialize( _object as ICollection, _useType, _parentNode, _serializer );
    ...
    /// <returns>TRUE always</returns>
    public bool Deserialize( CWorkingObject _object, XmlElement _parentNode, CDeserializer _deserializer ) => 
        BasicDeserialize( _object, _parentNode, _deserializer );
    ...
    protected override void AddElement( Hashtable _collection, DictionaryEntry _element ) => 
        _collection.Add( _element.Key, _element.Value );
}