...
namespace Morpheus
{
    ...
    /// <see cref="DefaultDispatchMode"/> property of the Dispatcher will be used.
    /// 
    ...
    public class Dispatcher
    {
        ...
        /// the <see cref="MessageHandler.SpecificValueFilter"/> will contain the exact value
        /// of the event used to trigger the handler. It will also contain the
        /// <see cref="Dispatcher"/> reference, but not the convenience of a strongly
        /// typed Dispatcher.
        /// </remarks>
        ...
        /// <summary>
        /// Given a <see cref="MessageHandler"/> , remove it from the list of handlers.
        /// </summary>
        ...
        public void Post( object _event, EDispatchMode _dispatchMode = EDispatchMode.NotAssigned )
        {
            ...
            // Deconstruct the event and queue up handlers for all levels of the event's
            // object heirarchy
        ...
        {
            // Check to see if there are any handlers for the Type at this level of the
            // hierarchy
            if (m_handlersForTypes.TryGetValue( _type, out var list ))
            {
                // There is (or at least was) a handler- go through all of the handlers
                // currently registered for the Type
                for (var i = 0; i < list.Count; i++)
                {
                    var handler = list[i];
                    ...
                    // Figure out how this handler should be executed based on the
                    // EDispatchThread for it
        ...
        /// long as its base class is still <see cref="MessageHandlingInstance"/>
        /// </summary>
