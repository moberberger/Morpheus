...
public class ProbabilityGenerator
{
    ...
    public CanonicalGeneticEvolver Evolver;
    public readonly EvolutionEngine<ulong[]> Engine;
    ...
    public ProbabilityGenerator( double targetValue, params double[] values )
    {
        ...
        Evolver = new CanonicalGeneticEvolver( DeviationFn.CalculateDeviation );
        Engine = new EvolutionEngine<ulong[]>(
            PopulationSize,
